...
var our_data = d3.csv("https://raw.githubusercontent.com/tigerlily-he/W4995-06-A4/master/msa.csv", d3.autoType)

console.log(Promise.resolve(our_data))

async function doAsync() {
    return await console.log(our_data)
}
var async_out_data = doAsync()
console.log(async_out_data)
console.log("hi")

// var races = [...new Set(our_data.map(item => item["Shooter Race"]))]
...
//   const first_layer = svg.append("g");
